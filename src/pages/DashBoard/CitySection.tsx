            ...
            <div style={{ justifyContent: 'right' }} className={'flexbox-container'}>
              <div style={{ justifyContent: 'center' }} className={'flexbox--vertical-container'}>
                ...
                <p style={{ textAlign: 'center', maxWidth: '500px', fontSize: '15px' }}>
                  We are for those who seek high rewards. For those who want nudes not nodes. For fast cars, not farmers
                  on tractors. IF you think this applies to you, this is where you belong.
                  <div className={'flexbox-container'}>
                    ...
                    <div style={{ textAlign: 'center', marginRight: '50px' }} className={'flexbox--vertical-container'}>
                ...
                <p style={{ maxWidth: '400px', textAlign: 'left', fontSize: '15px' }}>
                  {' '}
                  We will utilize our buy and sell tax to make strategic investments in projects that meet our criteria
                  for growth
                </p>
                ...
                <div style={{ justifyContent: 'center', marginBottom: '40px' }} className="flexbox-vertical-container">
                  <button
                    onClick={() =>
                      window.open(
