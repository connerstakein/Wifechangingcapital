...
//const antIcon = <LoadingOutlined style={{ fontSize: 24 }} spin /> // animated ^^
...
const Companytest = () => {
  ...
  const props = useSpring({
    config: { duration: 1000, delay: 10000 },
    to: { opacity: 1 },
    from: { opacity: 0 },
  })
  ...
  return (
    <>
      <animated.div hidden={hidden} style={props} className={'animate__animated animate__fadeInRight'}>
              ...
              <div style={{ marginLeft: '50px', marginTop: '100px' }} className={'vertical-align-middle'}>
                <div style={{ justifyContent: 'right' }} className={'flexbox-container'}>
                  <div style={{ justifyContent: 'center' }} className={'flexbox--vertical-container'}>
                    ...
                    >
                      {' '}
                      Were developing a Gamefi Dating App involving NFTs, Matchmaking and fun that will help you find
                      your new Wife{' '}
                    </p>
