      ...
      <div className={'animate__animated animate__backInRight'}>
        <div className={'flexbox-container'}>
          ...
          <div style={{ marginTop: '80px' }} className="flexbox-vertical-container-left">
            ...
            <p>
              {' '}
              Come with us on a journey to change your life, and if you need to along the way you could just change your
              wife
            </p>
            <PurpleCard>
              <div className="flexbox-container">
            ...
            <div className="flexbox-container">
              ...
              <TelegramButton onClick={() => window.open('https://t.me/WCCPortal', '_blank')}> Telegram</TelegramButton>
            </div>
          </div>
        </div>
      </div>
